        ...
        public void GetAllGroupsByTeacher()
        {
            ...
            WritingCorrectId: ConsoleHelper.WriteTextWithColor(ConsoleColor.Green, "Please choose teacher id to continue");
                ...
                if (result)
                {
                    ...
                    if (teacher!=null)
                    {
                var groups = _groupRepository.Get(g => g.teacher !=null? g.teacher.Id == teacher.Id : false);
                    if (groups!=null)
                    {

                    ConsoleHelper.WriteTextWithColor(ConsoleColor.Cyan, $"{teacher.Name} {teacher.Surname} ");
